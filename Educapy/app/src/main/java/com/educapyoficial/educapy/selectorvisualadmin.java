...
public class selectorvisualadmin extends AppCompatActivity {
 ...
 //   String jalogkeR;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCircleImageBackR.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(selectorvisualadmin.this, principal.class));
                finish();
            }
        });
        ...
        tarjeta1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(selectorvisualadmin.this, administradorGaleria.class);
        ...
        tarjeta2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(selectorvisualadmin.this, addVideoActivity.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(selectorvisualadmin.this, principal.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK); //PARA QUE EL CONDUCTOR NO REGRESE A LA ACTIVIDAD DE CREAR CUENTA
        startActivity(intent);
    }
