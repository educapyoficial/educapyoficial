...
public class revisarAsistenciaProfesor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDialog = new SpotsDialog.Builder().setContext(revisarAsistenciaProfesor.this).setMessage("Espere Un Momento").build();
        ...
        mCircleImageNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent myIntent = new Intent(revisarAsistenciaProfesor.this, revisaAsistenciaFinal.class);
        ...
        databaseReference.child("AsistenciaId").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot objSnaptshot : dataSnapshot.getChildren()) {
                    ...
                    arrayAdapterEspecialidad = new ArrayAdapter<constructoAsistenciaRevision>(revisarAsistenciaProfesor.this, android.R.layout.simple_list_item_1, listEspecialidad);
