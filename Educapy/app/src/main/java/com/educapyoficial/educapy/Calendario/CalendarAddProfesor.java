...
public class CalendarAddProfesor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDialog = new SpotsDialog.Builder().setContext(CalendarAddProfesor.this).setMessage("Espere Un Momento").build();
        ...
        btncalendar.setOnClickListener(new View.OnClickListener() {
          //  @RequiresApi(api = Build.VERSION_CODES.N)
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialogoFecha = new DatePickerDialog(CalendarAddProfesor.this, listenerDeDatePicker, ultimoAnio, ultimoMes, ultimoDiaDelMes);
                //Mostrar
                dialogoFecha.show();
            ...
            public void onClick(View v) {
              ...
              //  String tipodeEventoRR = cajatipoevento.getText().toString();
                ...
                if (nombre.isEmpty()||editextfechaevento.isEmpty()){
                    ...
                    Toast.makeText(CalendarAddProfesor.this,"Eliminado", Toast.LENGTH_LONG).show();
                    limpiarCajas();
                    Intent intent = new Intent(CalendarAddProfesor.this, MenuProfesores.class);
        ...
        mCircleUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nombre.isEmpty()||tipodeEventoRR.isEmpty()||editextfechaevento.isEmpty()){
                    ...
                    Toast.makeText(CalendarAddProfesor.this,"Actualizado", Toast.LENGTH_LONG).show();
                    limpiarCajas();
                }
            }
        });
        ...
        mCircleImageNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (nombre.isEmpty()||tipodeEventoRR.isEmpty()||editextfechaevento.isEmpty()){
                    validacion();
                    Toast.makeText(CalendarAddProfesor.this, "no validado", Toast.LENGTH_SHORT).show();
                }
                else {
                 //   Toast.makeText(CalendarAdd.this, "validado", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(CalendarAddProfesor.this, "Agregado", Toast.LENGTH_SHORT).show();
                    limpiarCajas();
        ...
        mAdapter = new ArrayAdapter<String>(CalendarAddProfesor.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.tipoEventoC));
        ...
        databaseReference.child("Calendario").child("Eventos").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot objSnaptshot : dataSnapshot.getChildren()) {
                    ...
                    arrayAdapterEspecialidad = new ArrayAdapter<constructorCalendario>(CalendarAddProfesor.this, android.R.layout.simple_list_item_1, listEspecialidad);
