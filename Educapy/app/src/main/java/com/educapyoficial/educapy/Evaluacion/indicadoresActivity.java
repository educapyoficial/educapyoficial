...
public class indicadoresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ArrayAdapter<String>(indicadoresActivity.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.indica1Q));
        spinneridentidad1.setAdapter(mAdapter);

        mAdapter2 = new ArrayAdapter<String>(indicadoresActivity.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.indica2Q));
        spinneridentidad2.setAdapter(mAdapter2);

        mAdapter3 = new ArrayAdapter<String>(indicadoresActivity.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.indica3Q));
        spinneridentidad3.setAdapter(mAdapter3);

        mAdapter4 = new ArrayAdapter<String>(indicadoresActivity.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.autonomia1Q));
        spinnerAutonomia1.setAdapter(mAdapter4);

        mAdapter5 = new ArrayAdapter<String>(indicadoresActivity.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.autonomia2Q));
        spinnerAutonomia2.setAdapter(mAdapter5);

        mAdapter6 = new ArrayAdapter<String>(indicadoresActivity.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.autonomia3Q));
        spinnerAutonomia3.setAdapter(mAdapter6);

        mAdapter7 = new ArrayAdapter<String>(indicadoresActivity.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.autonomia4Q));
        spinnerAutonomia4.setAdapter(mAdapter7);

        mAdapter8 = new ArrayAdapter<String>(indicadoresActivity.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.convivencia1Q));
        spinnerConvivencia1.setAdapter(mAdapter8);

        mAdapter9 = new ArrayAdapter<String>(indicadoresActivity.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.convivencia2Q));
        spinnerConvivencia2.setAdapter(mAdapter9);

        mAdapter10 = new ArrayAdapter<String>(indicadoresActivity.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.convivencia3Q));
        spinnerConvivencia3.setAdapter(mAdapter10);

        mAdapter11 = new ArrayAdapter<String>(indicadoresActivity.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.convivencia4Q));
        spinnerConvivencia4.setAdapter(mAdapter11);

        mAdapter12 = new ArrayAdapter<String>(indicadoresActivity.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.vidaSaludable1Q));
        spinnervidaSaludable1.setAdapter(mAdapter12);

        mAdapter13 = new ArrayAdapter<String>(indicadoresActivity.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.vidaSaludable2Q));
        spinnervidaSaludable2.setAdapter(mAdapter13);

        mAdapter14 = new ArrayAdapter<String>(indicadoresActivity.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.vidaSaludable3Q));
            ...
            mDatabase.child("Users").child("Clients").child(obtengogkeR).updateChildren(personmap).addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void aVoid) {
                 ...
                 //   startActivity(intent);
                    Toast.makeText(indicadoresActivity.this, "Indicadores Actualizados", Toast.LENGTH_SHORT).show();
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                     Toast.makeText(indicadoresActivity.this, "Indicadores no actualizados", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(indicadoresActivity.this, evaluacionVentana.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK); //PARA QUE EL CONDUCTOR NO REGRESE A LA ACTIVIDAD DE CREAR CUENTA
        startActivity(intent);
    }
}