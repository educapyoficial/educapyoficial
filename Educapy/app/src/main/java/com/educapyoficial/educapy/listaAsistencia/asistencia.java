...
public class asistencia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDialog = new SpotsDialog.Builder().setContext(asistencia.this).setMessage("Espere Un Momento").build();
        ...
        mCircleDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nombre.isEmpty()||editextfechaevento.isEmpty()){
                    ...
                    Toast.makeText(asistencia.this,"Eliminado", Toast.LENGTH_LONG).show();
                    limpiarCajas();
            ...
            public void onClick(View v) {
                ...
                if (nombre.isEmpty()||tipodeEventoRR.isEmpty()||editextfechaevento.isEmpty()){
                  ...
                  //  p.setFotourl(obtengoUrlFoto);
                    ...
                    Toast.makeText(asistencia.this,"Actualizado", Toast.LENGTH_LONG).show();
                    limpiarCajas();
                }
            }
        });
        ...
        mCircleImageAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (nombre.isEmpty()||tipodeEventoRR.isEmpty()){
                    validacion();
                    Toast.makeText(asistencia.this, "no validado", Toast.LENGTH_SHORT).show();
                }
                else {
                 ...
                 //   p.setTipodeEvento(cajatipoevento.getText().toString());
                    ...
                    mDatabase.child("AsistenciaId").child(cajaFechaEvento.getText().toString()).updateChildren(personmap).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(asistencia.this, "Dato Actualizado", Toast.LENGTH_SHORT).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(asistencia.this, "Fallo al Actualizar", Toast.LENGTH_SHORT).show();
                        }
                    });
        ...
        mCircleRegistroCalendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialogoFecha = new DatePickerDialog(asistencia.this, listenerDeDatePicker, ultimoAnio, ultimoMes, ultimoDiaDelMes);
                //Mostrar
                dialogoFecha.show();
        ...
        mAdapter = new ArrayAdapter<String>(asistencia.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.AsistenciaC));
    ...
    public void actualizaCalificacion() { //este metodo actualiza un solo elemento o crea un nuevo elemento sin que se aya creado :)
        ...
        mDatabase.child("Calificaciones").child(almacenagkeR).updateChildren(personmap).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                Toast.makeText(asistencia.this, "Nombre Actualizado", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
        ...
        databaseReference.child("Users").child("Clients").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot objSnaptshot : dataSnapshot.getChildren()) {
                    ...
                    arrayAdapterEspecialidad = new ArrayAdapter<constructoAsistencia>(asistencia.this, android.R.layout.simple_list_item_1, listEspecialidad);
