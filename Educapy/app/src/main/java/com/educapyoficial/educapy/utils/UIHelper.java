 ...
 * ALL RIGHTS RESERVED
 ***********************************************/
package com.educapyoficial.educapy.utils;
...
public class UIHelper {
	...
	public void updateLoadingDialog(final String message) {
		if (activity != null && activity instanceof FinishInfo
				&& ((FinishInfo) activity).isFinished() == true) {
			return;
		}
		if (activity != null) {
			activity.runOnUiThread(new Runnable() {
	...
	public void showInfoDialog(String infoMessage) {
		...
		new AlertDialog.Builder(activity).setMessage(infoMessage)
				.setTitle("Info")
				.setPositiveButton("OK", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int id) {
						dialog.dismiss();
