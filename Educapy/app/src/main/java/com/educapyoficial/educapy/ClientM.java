...
public class ClientM {
    ...
    //creo el constructor con estos parametros para enviarle al firebase id, name,email,telefono aunque solo se esta usando name y email los demas los dejo por si quieren agregar mas campos
    //esto lo uso para que los clientes puedan loguear y registrarse
    String id;
    String nombre1R;
    String emailR;
    String foto;
    ...
    public ClientM(String id, String nombre1R, String emailR, String foto, String idgruR, String apellidos1R, String lollaman1R, String lugarnacimiento1R, String edad1R, String peso1R, String estatura1R, String domicilio1R, String telefono1R, String almacenasexo1R, String calificacionR, String gkeR, String institucioneducativaR, String espacioeducativoOR, String finalizarprescolarR, String escribirsunombreR, String leerpalabraR, String contarR, String paisRegister2R, String paisRegister3R, String paisRegister4R, String telefono2R, String nombremama2R, String estudioscursamamaR2, String ocupacionmama2R, String nacimientomama2R, String telefonomama2R, String telefonomovilmama2R, String horariomama2R, String nombrepapa2R, String estudiospapa2R, String ocupacionpapa2R, String lugartrabajopapa2R, String telefonocasapapa2R, String telefonocelularpapa2R, String horariotrabajopapa2R, String numeropersonashogar2R, String cuantoshermanos2R, String lugarocupa2R, String vivecon2R, String relacionmama2R, String relacionpapa2R, String relacionhermano2R, String comofueembarazo3R, String comofueparto3R, String destete3R, String lechematerna3R, String primeraspalabras3R, String legustacomer3R, String familiarcomejun3R, String duermebien3R, String cuandolesalieron3R, String sanosusdientes3R, String controlesfinteres3R, String pronunciabien3R, String comprendeloquedice3R, String comosecomporta3R, String comosecomportacalle3R, String actividadescotidianas3R, String sevistesolo3R, String legustaquehacer3R, String uid, String nombreUsuario) {
        this.id = id;
