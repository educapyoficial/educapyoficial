...
public class revisarAsistencia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDialog = new SpotsDialog.Builder().setContext(revisarAsistencia.this).setMessage("Espere Un Momento").build();
        ...
        mCircleImageNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent myIntent = new Intent(revisarAsistencia.this, revisaAsistenciaFinal.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(revisarAsistencia.this, menuadministrador.class);
        ...
        databaseReference.child("AsistenciaId").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot objSnaptshot : dataSnapshot.getChildren()) {
                    ...
                    arrayAdapterEspecialidad = new ArrayAdapter<constructoAsistenciaRevision>(revisarAsistencia.this, android.R.layout.simple_list_item_1, listEspecialidad);
