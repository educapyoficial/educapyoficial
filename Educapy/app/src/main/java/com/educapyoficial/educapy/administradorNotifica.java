...
public class administradorNotifica extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDialog = new SpotsDialog.Builder().setContext(administradorNotifica.this).setMessage("Espere Un Momento").build();
        ...
        mCircleImageBackad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myIntent = new Intent(administradorNotifica.this, principal.class);
        ...
        btnespecifico.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!nomp.isEmpty() && !titulo.isEmpty() && !cuerpo.isEmpty()) {
                    enviaraespecifico();
                    Toast.makeText(administradorNotifica.this, "Mensaje Enviado a Estudiante", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(administradorNotifica.this, "Selecciona un usuario", Toast.LENGTH_SHORT).show();
                }
                //  enviaraespecifico();
            }
        });
        ...
        btnatopico.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!nomp.isEmpty() && !titulo.isEmpty() && !cuerpo.isEmpty()) {
                    ...
                    Toast.makeText(administradorNotifica.this, "Llena todos los campos", Toast.LENGTH_SHORT).show();
                }
                //  enviarnotiall();
        ...
        databaseReference.child("Users").child("Clients").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot objSnaptshot : dataSnapshot.getChildren()) {
                    ...
                    arrayAdapterColaboradores = new ArrayAdapter<EducapyModelUser>(administradorNotifica.this, android.R.layout.simple_list_item_1, listcolaboradores);
    ...
    private void showSucessDialogNOTI() {
        ...
        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(administradorNotifica.this, R.style.AlertDialogTheme);
        View view = LayoutInflater.from(administradorNotifica.this).inflate(
        ...
        view.findViewById(R.id.buttonYesRR).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(administradorNotifica.this, "Mensaje enviado a todos los usuarios", Toast.LENGTH_SHORT).show();
                enviarnotiall();
                alertDialog.dismiss();
            }
        });
